...
#ifdef CONFIG_NF_CONNTRACK_TP_APP
#define NF_CT_EXT_APP_TYPE struct nf_conntrack_app
#define NF_CT_EXT_APP_ANALYSIS_TYPE struct _nf_app_log
#define NF_CT_EXT_SPF_TYPE struct nf_conntrack_spf
#endif

...
static int __init huawei_cdc_ncm_init(void)
{


	return usb_register(&huawei_cdc_ncm_driver);
}
module_init(huawei_cdc_ncm_init);

static void __exit huawei_cdc_ncm_exit(void)
{
	usb_deregister(&huawei_cdc_ncm_driver);
}
module_exit(huawei_cdc_ncm_exit);

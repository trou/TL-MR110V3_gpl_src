...
#if defined(CONFIG_TP_MODEL_MR100V1) || defined(CONFIG_TP_MODEL_MR100V2)|| defined(CONFIG_TP_MODEL_MR402V1)
		if (usb_dev->descriptor.idVendor == 0x1286 &&
				(usb_dev->descriptor.idProduct == 0x4e31 ||
				usb_dev->descriptor.idProduct == 0x4e3c ||
				usb_dev->descriptor.idProduct == 0x4e3d))
		{
...
static const struct usb_device_id acm_ids[] = {
    ...
    { USB_DEVICE(0x1286, 0x4e31), /* asr1802 acm devices */
    .driver_info = NO_UNION_NORMAL, /* has no union descriptor */
	},
    { USB_DEVICE(0x1286, 0x4e3c), /* asr1802 acm devices */
    .driver_info = NO_UNION_NORMAL, /* has no union descriptor */
	},

...
#define CONFIG_BOOTDELAY	1	/* autoboot after 5 seconds	change to 1 sec*/

#define CONFIG_BAUDRATE		115200 /*57600, change to 115200 by wanghao*/
...
#else
/* Init network settings for TPLINK, yuanshang, 2013-09-13 */
#define CONFIG_SERVERIP 192.168.0.225
#define CONFIG_IPADDR 192.168.0.2
#define CONFIG_ETHADDR "00:0A:EB:13:09:69"
#endif
...
/*
**	Now we didn't use Uboot UC && RF section, so we change these sizes.
@@	By TengFei, 13/01/25
*/
...
/* Port from soho, yuanshang, 2013-9-16 */
/*
**	Now we didn't use Uboot UC && RF section, so we change these addresses.
@@	By TengFei, 13/01/25
*/
#if !defined(ENV_IS_EMBEDDED)
...
//#define CFG_ROOTFS_ADDR	(CFG_FLASH_BASE + PRODUCT_FLASH_ROOTFS_OFFSET)
//#define CFG_USRCFG_ADDR	(CFG_FLASH_BASE + PRODUCT_FLASH_UC_OFFSET)
//#define CFG_ARTDATA_ADDR	(CFG_FLASH_BASE + PRODUCT_FLASH_ART_OFFSET)
#endif

...
ifeq ($(EXTERNAL_RF_SWITCH),y)
CPPFLAGS += -DEXTERNAL_RF_SWITCH
endif

ifeq ($(EXTERNAL_PA_LNA),y)
CPPFLAGS += -DEXTERNAL_PA_LNA
endif
...
ifeq ($(SPI_FLASH_DBG_CMD),ON)
CPPFLAGS += -DSPI_FLASH_DBG_CMD
endif
...
ifeq ($(TP_MODEL_WR840NV4),y)
CPPFLAGS += -DTP_MODEL_WR840NV4
endif

ifeq ($(TP_MODEL_WR841NV13),y)
CPPFLAGS += -DTP_MODEL_WR841NV13
endif

ifeq ($(TP_MODEL_WR845NV3),y)
CPPFLAGS += -DTP_MODEL_WR845NV3
endif
...
ifeq ($(CONFIG_TINY_UBOOT), y)
CONFIG_CROSS_COMPILER_PATH = $(TOPDIR)/../../build/buildroot-gcc463/bin

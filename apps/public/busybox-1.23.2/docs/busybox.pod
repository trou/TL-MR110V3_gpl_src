...
Currently available applets include:
	...
	[, [[, arping, ash, basename, blkid, brctl, cat, chmod, cp, cut,
	date, df, echo, egrep, env, fgrep, find, free, getty, grep, gzip,
	halt, head, ifconfig, init, insmod, ipcrm, ipcs, kill, killall,
	linuxrc, ln, logger, login, ls, lsmod, mkdir, mount, netstat, pidof,
	ping, ping6, poweroff, ps, reboot, rm, rmmod, route, sed, sh, sleep,
	tail, tar, taskset, telnet, telnetd, test, tftp, touch, tr, umount,
	uname, vconfig
